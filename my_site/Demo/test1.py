...
classifierNames = ["LogisticRegression"]
...
##  to disable the warnings
    ...
    if style == 0:
        ...
        '''
        #for logis
        trainingClassifierFeatures = trainingClassifierFeatures[:1000]
        trainingTargets = trainingTargets[:1000]
        testClassifierFeatures = testClassifierFeatures[:100]
        ...
        testClassifierFeatures = np.array(testClassifierFeatures)
        testTargets = np.array(testTargets)

        print('training size =', trainingDataSize, 'test size =', testDataSize)
...
#             classifiers[i].fit(trainingClassifierFeatures, trainingTarget)
        ...
        #classifiers[1].fit(trainingClassifierFeatures, trainingTargets)
        #classifiers[2].fit(trainingClassifierFeatures, trainingTargets)
        #classifiers[3].fit(trainingClassifierFeatures, trainingTargets)
